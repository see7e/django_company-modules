...
2. **Put-away**: The process of placing goods in a warehouse
...
This application will be used to implement an Event Driven Architecture (EDA).

> In this moment in using the Event model as the
