    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                ...
                HTML('<a href="{% url "register_login:sso_login" %}" class="btn btn-outline-dark mx-4 my-2">Or login with SSO</a>'),
                css_class='d-grid',
            )    
        )
...
class UpdateCustomUserForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        btns = self.set_edit_mode(True if 'initial' in kwargs and 'edit' in kwargs['initial'] else False)
    ...
    def set_edit_mode(self, mode):
        if mode:
            ...
            return (
                HTML('<a href="{% url "register_login:profile" %}" class="btn btn-outline-danger me-2">Cancel</a>'),
            ...
            for field in self.fields:
                ...
                self.fields[field].readonly = True
            return (
                HTML('<a href="{% url "register_login:profile_edit" %}" class="btn btn-primary">Edit</a>'),
            )
